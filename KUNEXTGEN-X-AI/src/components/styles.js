...
@media (max-width: 640px) {
  ...
  @media (min-width: 641px) and (max-width: 1024px) {
    ...
    .main-panel {
      ...
      background: linear-gradient(180deg, #eef2f2 0%, #dde3e2 100%) !important;
    }

    body.dark .main-panel {
      background: linear-gradient(180deg, #11212D 0%, #253745 100%) !important;
    }
    ...
    .empty-main {
      ...
      border: 1px solid rgba(6,20,27,0.08);
      box-shadow: 0 20px 44px rgba(6,20,27,0.08);
    }
  ...
  @media (max-width: 640px) {
    ...
    body {
      overflow-y: auto !important;
      background: linear-gradient(180deg, #eef2f2 0%, #dbe1df 100%) !important;
    }
    ...
    .topnav {
      ...
      border-bottom: 1px solid rgba(6,20,27,0.08);
      box-shadow: 0 12px 28px rgba(6,20,27,0.08);
    }

    body.dark .topnav {
      background: rgba(6,20,27,0.88) !important;
    ...
    .topnav-btn {
      ...
      padding: 0 10px;
      font-size: 11px;
      box-shadow: 0 8px 16px rgba(6,20,27,0.08);
    }
    ...
    .sidebar {
      ...
      background:
        radial-gradient(circle at top left, rgba(255,255,255,0.04), transparent 24%),
        linear-gradient(180deg, #071a22 0%, #07161d 100%) !important;
    }
    ...
    .sidebar-footer {
      ...
      z-index: 3;
      padding: 12px;
      background: linear-gradient(180deg, rgba(7,22,29,0), rgba(7,22,29,0.98) 36%);
      border-top: 1px solid rgba(255,255,255,0.06);
  ...
  @media (max-width: 640px) {
    ...
    body:not(.dark) .topnav {
      background: rgba(244, 247, 247, 0.88) !important;
    }

    body.dark .topnav {
      background: rgba(9, 18, 33, 0.88) !important;
    }
    ...
    .quiz-question {
      border-radius: 24px;
      box-shadow: 0 14px 32px rgba(6,20,27,0.12);
    }
    ...
    .sidebar {
      ...
      background:
        ...
        linear-gradient(180deg, #09182a 0%, #07161d 100%) !important;
    ...
    .layout.mobile-sidebar-open .main-panel {
      filter: blur(1px);
      opacity: 0.22;
      pointer-events: none;
      user-select: none;
    ...
    .sidebar-inner {
      padding: 8px 12px 98px !important;
      gap: 12px;
    }
    ...
    .upload-zone {
      ...
      border-radius: 20px;
      background:
        linear-gradient(180deg, rgba(66, 105, 196, 0.08), rgba(255,255,255,0.03)),
        rgba(18, 33, 54, 0.86);
      border-style: solid;
      border-color: rgba(92, 127, 230, 0.28);
    }
    ...
    .file-type-badge {
      background: rgba(78, 110, 210, 0.18);
      border-color: rgba(92, 127, 230, 0.28);
      color: #b8c9ff;
    }
    ...
    .option-card {
      ...
      border-color: rgba(79, 111, 210, 0.18);
    }

    .option-card.selected {
      background: rgba(34, 53, 93, 0.96);
      border-color: rgba(92, 127, 230, 0.42);
      box-shadow: 0 0 0 1px rgba(92, 127, 230, 0.24), 0 12px 24px rgba(0,0,0,0.2);
      transform: none;
    }
    ...
    .sidebar-footer {
      ...
      background: linear-gradient(180deg, rgba(7,22,29,0), rgba(7,22,29,0.98) 24%);
    }
    ...
    .action-btn {
      ...
      border-radius: 18px;
      font-size: 16px;
      box-shadow: 0 16px 30px rgba(61, 103, 225, 0.22);
    }
    ...
    .stat-card {
      ...
      border-color: rgba(79, 111, 210, 0.16);
    }
